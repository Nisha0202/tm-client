  ...
  return (
    <div>
        <div className="container p-4">
            <h2 data-tooltip-id="my-tooltip" data-tooltip-content="About Us" className="text-2xl font-bold text-center my-6">About Us</h2>
            <p className="text-base/loose max-w-3xl mx-auto inter text-center py-3 px-4">
