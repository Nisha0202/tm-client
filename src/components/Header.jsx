...
export default function () {
  ...
  return (
    <>
      <div className="navbar bg-base-100 px-4 lg:px-0 py-6 flex flex-col md:flex-row items-center justify-between">
        <div className="md:navbar-start flex gap-4">
          <a href='/' className="text-md md:text-2xl imprima text-indigo-700 font-bold">TM</a>

          <label className="md:hidden flex swap swap-rotate" data-tooltip-id="my-tooltip" data-tooltip-content="display mode">
            ...
            <div className="md:navbar-end">
              ...
              <div className="avatar border-2 rounded-full">
                <NavLink to='/user' className="w-8 rounded-full">
                  <img className='object-contain rounded-full' src={usern.photoURL} alt="user" title={usern.displayName} />
                </NavLink>
              </div>
        ...
        <label className="hidden md:flex swap swap-rotate" data-tooltip-id="my-tooltip" data-tooltip-content="display mode">
